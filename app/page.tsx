  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center w-full max-w-sm relative z-10">
        ...
        <p className="text-zinc-500 mb-20 text-sm">Intelligent. Simplified.</p>
        ...
        <p className="mt-12 text-sm text-zinc-600 text-center leading-relaxed">
          By continuing you agree to <a href="#" className="text-zinc-400 hover:underline">Terms</a> and <br />
